...
import SportFuelCartItemComponent from '../components/SportFuelCartItemComponent';
import SportFuelComponent from '../components/SportFuelComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <SportFuelCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
